...
import helper
from cogs.classes.musicplayer import MusicPlayer
...
class Music(commands.Cog):
    ...
    @commands.command(name="join", aliases=["connect"], help="Connects to your voice channel")
    ...
    @commands.command(name="resume", aliases=["unpause"], help="Resumes the player")
    ...
    @commands.command(name="leave", aliases=["disconnect", "dc"], help="Disconnects bot from the voice channel")
    ...
    @commands.command(name="nowplaying", aliases=["np", "song"], help="Displays info about the current song")
    ...
    @commands.command(name="skip", aliases=["next"], help="Skips the current song being played")
    ...
    @commands.command(name="back", aliases=["previous", "prev"], help="Returns to the previous song in queue")
    ...
    @commands.command(name="jump", aliases=["j"], help="Jumps to a song by track position or title")
    ...
    @commands.command(name="remove", aliases=["r"], help="Removes a song by track position or title")
    ...
    @commands.command(name="removerange", aliases=["rr"], help="Removes all songs between two positions, inclusive")
    ...
    @commands.command(name="shuffle", help="Shuffles the remaining songs in the queue")
    ...
    @commands.command(name="loop", aliases=["looptrack", "loopt"], help="\"on\" or \"off\", or toggles looping of the current track")
    async def loop(self, ctx, option: str = None) -> None:
        ...
        if await self.check_caller(ctx, player):
            ...
            # Let MusicPlayer take over from here
            await player.loop(ctx, option)

    @commands.command(name="loopqueue", aliases=["loopq"], help="\"on\" or \"off\", or toggles looping of the current queue")
    async def loopqueue(self, ctx, option: str = None) -> None:
        ...
        if await self.check_caller(ctx, player):
            ...
            # Let MusicPlayer take over from here
            await player.loopqueue(ctx, option)

    @commands.command(name="shuffleloop", aliases=["loopshuffle"], help="Shuffles the queue when player %loopqueue back to the start")
    async def shuffleloop(self, ctx, option: str = None) -> None:
        ...
        if await self.check_caller(ctx, player):
            ...
            # Let MusicPlayer take over from here
            await player.shuffleloop(ctx, option)

    # SAVING/LOADING #

    @commands.command(name="namequeue", aliases=["nameq"], help="Names the current queue")
    async def namequeue(self, ctx, *, queue_name: str = None) -> None:
    ...
    @commands.command(name="savequeue", aliases=["saveq"], help="Saves the current queue to your personal list")
    async def savequeue(self, ctx, *, queue_name: str = None) -> None:
    ...
    @commands.command(name="loadqueue", aliases=["loadq"], help="Loads and starts a queue from your personal list")
    ...
    @commands.command(name="showqueues", aliases=["showqueue", "showq", "showqs"], help="Previews your list of saved queues")
    ...
    @commands.command(name="addqueue", aliases=["addq", "appendqueue", "appendq"], help="Appends a queue from your list to current queue")
