...
class Misc(commands.Cog):
	...
	async def annoy(self, ctx, *, member: discord.Member = None) -> None:
		...
		if member is None:
			...
			printinf(f"No longer annoying anybody in {ctx.guild}")
		...
		# Attempt to annoy bot itself
			...
			printinf(f"Now annoying {member} in {ctx.guild}")
	...
	@commands.command(name="tragedy", help="Educates you on the tragedy of Darth Plagueis the Wise")
